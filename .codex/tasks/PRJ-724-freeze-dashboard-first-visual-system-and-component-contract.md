...
## Definition of Done
- [ ] shared component families are enumerated
- [ ] dashboard-first IA is frozen
- [ ] the contract explicitly prioritizes the first motif image over colder dashboard styling
