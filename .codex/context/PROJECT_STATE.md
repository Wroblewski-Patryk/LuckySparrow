...
- Current runtime emphasis: lightweight goal and milestone management now includes phase, arc, pressure, dependency, due, risk, and completion signals, still without a heavyweight milestone engine
- Top blockers:
