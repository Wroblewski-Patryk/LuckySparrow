...
- next improvement:
  ...
  - decide whether `goal_milestone_arc` should remain a lightweight semantic compression over milestone history, or become part of a richer milestone-lifecycle model with stronger state transitions
