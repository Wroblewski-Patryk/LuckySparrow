...
- next improvement:
  ...
  - decide how far to push `aion_goal_milestone` before introducing richer milestone semantics such as dependencies, due signals, explicit completion criteria state, or milestone-level ownership/history
