...
| PRJ-994 | Re-audit next route-local extraction target after settings cleanup | READY_AFTER_PRJ-993 | choose the next route/component extraction slice from the current `App.tsx` after tools and settings ownership cleanup |
