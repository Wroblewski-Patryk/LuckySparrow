...
| PRJ-1008 | Audit next chat route presentation extraction after transcript row cleanup | READY_AFTER_PRJ-1007 | choose between cognitive belt, portrait/support panel, or transcript shell extraction without disturbing canonical chat layout |
