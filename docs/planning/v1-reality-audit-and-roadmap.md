...
| PRJ-1017 | Extract chat route display-model helpers from `web/src/App.tsx` | READY_AFTER_PRJ-1016 | add `web/src/lib/chat-route-model.ts` for quick actions, focus, intent, motivation, goal, and related-memory projections |
