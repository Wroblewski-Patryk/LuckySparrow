...
| PRJ-993 | Extract settings formatting helpers from `web/src/App.tsx` | READY_AFTER_PRJ-992 | language and UTC offset formatting helpers move to a small lib module without bootstrap/settings behavior change |
