...
| PRJ-992 | Extract settings side panel presentation cluster from `web/src/App.tsx` | READY_AFTER_PRJ-991 | proactive/save/danger side panel chrome moves behind explicit props while save/reset behavior remains in `App()` |
