...
| PRJ-997 | Extract learned-state summary helpers from `web/src/App.tsx` | READY_AFTER_PRJ-996 | `recentActivityRows` and `summaryLines` move to a small learned-state formatting module while route data assembly remains in `App()` |
