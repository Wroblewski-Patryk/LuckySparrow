...
| PRJ-1005 | Extract chat composer shell from `web/src/App.tsx` | READY_AFTER_PRJ-1004 | action tray, mode tabs, composer shell, and composer note move to a chat component with explicit state/handler props |
