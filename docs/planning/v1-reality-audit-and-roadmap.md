...
| PRJ-1006 | Audit chat transcript presentation extraction after composer cleanup | READY_AFTER_PRJ-1005 | decide whether message-row/article chrome can move behind explicit props while markdown and delivery helpers stay module-owned |
