...
| PRJ-1014 | Audit next chat extraction target after portrait panel cleanup | READY_AFTER_PRJ-1013 | choose whether transcript shell, chat data helpers, or remaining route wrapper should move next |
