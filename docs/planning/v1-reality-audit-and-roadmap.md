...
| PRJ-981 | Extract shared stat-card component cluster from `web/src/App.tsx` | READY_AFTER_PRJ-980 | repeated route stat-card shapes move behind explicit props without route data behavior change |
