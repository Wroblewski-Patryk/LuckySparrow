...
| PRJ-1015 | Extract chat transcript shell from `web/src/App.tsx` | READY_AFTER_PRJ-1014 | add `ChatTranscriptShell` with forwarded container ref, loading fallback, transcript rows, and composer passed explicitly |
