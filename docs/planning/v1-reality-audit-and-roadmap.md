...
| PRJ-1007 | Extract chat transcript message row presentation from `web/src/App.tsx` | READY_AFTER_PRJ-1006 | add a chat transcript row component that receives precomputed speaker/timestamp/delivery/rendered-content props without moving transcript behavior |
