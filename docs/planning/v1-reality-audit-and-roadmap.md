...
| PRJ-1009 | Extract chat cognitive belt presentation from `web/src/App.tsx` | READY_AFTER_PRJ-1008 | add `ChatCognitiveBelt` that receives card data and goal progress as explicit props while route data derivation stays in `App()` |
